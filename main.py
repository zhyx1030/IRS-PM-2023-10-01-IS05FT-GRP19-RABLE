...
from utils.mnist import load_mnist, load_mnist_imb
from utils.fmnist import load_fmnist
from utils.kmnist import load_kmnist
from utils.cifar10 import load_cifar10, load_cifar10_imb, load_cifar10_reb
...
parser.add_argument('--dataset', default='cifar10', \
                    ...
                    choices=['mnist', 'fmnist', 'kmnist', 'cifar10','cifar10_imb', 'cifar10_reb','mnist_imb'])
...
def main():
    ...
    elif args.dataset == 'cifar10_imb':
        train_loader, train_partialY_matrix, test_loader = load_cifar10_imb(args)

    elif args.dataset == 'cifar10_reb':
        train_loader, train_partialY_matrix, test_loader = load_cifar10_reb(args)

    elif args.dataset == 'mnist_imb':
        train_loader, train_partialY_matrix, test_loader = load_mnist_imb(args)
    ...
    for epoch in range(0, args.epochs):
        ...
        if acc_test > best_acc:
            best_acc = acc_test
            torch.save(model.state_dict(), '/root/ABLE/ckpt/best_ckpt.pth')
